...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        if (_subcommand === "manual") {
            ...
            await (Character(charArgs)).save()

            // console.log(res)

            return interaction.reply("Character successfully added")
            ...
            try {
                ...
                await (Character(data)).save()

                interaction.editReply("Character added successfully")
